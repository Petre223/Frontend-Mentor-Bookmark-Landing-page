  ...
  return <>
    <section className='btn-blue px-8 py-20'>
        <div className='max-w-7xl mx-auto'>
            ...
            <h2 className='text-white text-4xl mb-8 lg:text-4xl text-center lg:w-96 lg:mx-auto'>Stay up-to-date with what we’re doing</h2>
            ...
            <form className='flex flex-col gap-4 md:flex-row md:items-center md:justify-center md:max-w-xl md:mx-auto'>
                <input 
                 ...
                 />
                <button type='submit' className='btn-red text-white py-2 px-4 rounded shadow-lg hover:opacity-55 md:w-1/3 text-sm'>
                    Contact Us
                </button>
            </form>
        </div>
